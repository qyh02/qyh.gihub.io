package com.qqq.usercenter.controller;
...
import com.qqq.usercenter.model.domain.request.UserLoginRequest;
import com.qqq.usercenter.model.domain.request.UserRegisterRequest;
...
import static com.qqq.usercenter.contant.UserConstant.ADMIN_ROLE;
import static com.qqq.usercenter.contant.UserConstant.USER_LOGIN_STATE;

/**
 * @author qqq
 * @description
 * @createDate 2023/6/20 23:37
 */
@RestController
@RequestMapping("/user")
public class UserController {
    ...
    public BaseResponse<User> getCurrentUser(HttpServletRequest request) {
        ...
        // todo 校验用户是否合法
        User safeuser = userService.getById(userId);
